...
public interface OrderRepository extends JpaRepository<Order, Integer> {
	...
	@Query(value = "SELECT * FROM orders WHERE deletion_flag = 0 AND room_no = ? AND account_id != ?", nativeQuery = true)
	public abstract List<Order> findOrdersExceptAccountId(Integer roomNo, Integer accountId);
